...
[7] Three concrete moments from Discover ground the problem.
...
[11] The product exists to answer those three moments: comparable runs, visible judgment, and a per-decision log that isolates each stage.
...
[72] Personas with tasks and per-task success criteria. Waived at the Discover gate; the four segments stand in.

[73] User flows and wireframes for the configuration screen, the live view, the inspector, and the comparison view. Design phase.

[74] Architecture, data model, event schema, and the proxy's API contract. Design phase.

[75] Non-functional requirements beyond the success criteria: browser support, bundle size, accessibility, offline replay. PRD.

[76] The exact Jev question wording and criteria for each drive, the fear Score levels, mate choice, nest safety, and cat targeting. Tech spec.
