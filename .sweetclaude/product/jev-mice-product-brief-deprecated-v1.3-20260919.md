...
audience: hybrid
nda: false
changes: minor. Removed licensing from Additional Development: the repository is private and carries no license at this time
previous_file: jev-mice-product-brief-deprecated-v1.2-20260919.md
---
...
[82] Test strategy, including how the flee-or-hide criterion and the personality-mix criterion are computed from telemetry in the test suite.
