...
previous_file: jev-mice-product-brief-deprecated-v1.1-20260919.md
---
...
**Run knobs.** Grid preset; tick count (default 2,000); random seed; male mice; female mice; cats; traps; food piles; food respawn interval; nutrition decay rate; personality percentages; Jev on or off (baseline mode). Defaults for Medium: 30 male, 30 female, 4 cats, 8 traps, 20 food piles, respawn 40, decay 0.5.
...
For mice with a cat within 3 cells and nutrition at or above 60 percent, at least 80 percent of Jev drive decisions in the run place a combined probability of 0.5 or more on flee and hide. This is the numeric guard against the Brownian-motion failure.
...
Terrain and obstacles, which would make hide a spatial behavior rather than a signal-field one.

Licensing for the showcase repository.
