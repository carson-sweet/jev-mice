# Designing around a System One model

**Date:** 2026-09-20

[jev-mice](https://mice.jev.carsonsweet.com) is a tick-based ecology on a grid -- mice, cats, traps, food, mouseholes -- where every animal's next move is arbitrated by [Jev](https://typesafe.ai), TypeSafe's System One model, instead of by the usual pile of hand-written behavior rules. It is the second thing I have built this way, after [Jev Plays Brogue](https://github.com/carson-sweet/jev-plays-brogue), and the second one is where the pattern actually got tested, because an ecology has sixty agents deciding at once instead of one.

This is a post about the boundary. Not about mice.
